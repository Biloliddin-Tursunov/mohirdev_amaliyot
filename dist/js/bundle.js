...
function form(formSelector) {
  ...
  async function postData(url, json) {
    const res = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, json);
    return await res;
  }
...
function planMenu(parentSelector) {
  //planMenu
  class PlanMenu {
...
function slider(
  ...
  class slides {
    ...
    async getData() {
      const res = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(this.url);
      return await res;
    }
    render() {
...
/* harmony export */ });
function tab(parentSelector, tabItems, Content) {
  // tab
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  //tab
  (0,_modules_tab__WEBPACK_IMPORTED_MODULE_1__["default"])(".tabheader__items", ".tabheader__item", ".tabcontent");

  //modal
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])(".modal", "[data-modal]");

  //planMenu
  (0,_modules_planMenu__WEBPACK_IMPORTED_MODULE_3__["default"])(".menu .container");

  //form
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_4__["default"])("form");

  //timer
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(".timer", "2023-01-01");
